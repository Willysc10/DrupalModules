// src/lib.rs
/*
 * Core library for DrupalModules
 */
...
#[derive(Debug)]
pub struct DrupalModulesProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DrupalModulesProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DrupalModules processing");
    
    let mut processor = DrupalModulesProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DrupalModulesProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DrupalModulesProcessor::new(false);
